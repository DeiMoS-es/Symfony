 ...
 */
final class Version20251228103640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_group_recommendation (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, deadline DATETIME NOT NULL, status VARCHAR(20) NOT NULL, final_score DOUBLE PRECISION DEFAULT NULL, total_votes INT DEFAULT 0 NOT NULL, avg_script DOUBLE PRECISION DEFAULT 0 NOT NULL, avg_main_actor DOUBLE PRECISION DEFAULT 0 NOT NULL, avg_main_actress DOUBLE PRECISION DEFAULT 0 NOT NULL, avg_secondary_actors DOUBLE PRECISION DEFAULT 0 NOT NULL, avg_director DOUBLE PRECISION DEFAULT 0 NOT NULL, group_id CHAR(36) NOT NULL, movie_id CHAR(36) NOT NULL, recommended_by_id CHAR(36) NOT NULL, INDEX IDX_30EF6577FE54D947 (group_id), INDEX IDX_30EF65778F93B6FC (movie_id), INDEX IDX_30EF6577D59A4918 (recommended_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE app_group_review (id CHAR(36) NOT NULL, score_script INT NOT NULL, score_main_actor INT NOT NULL, score_main_actress INT NOT NULL, score_secondary_actors INT NOT NULL, score_director INT NOT NULL, average_score DOUBLE PRECISION NOT NULL, comment VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, recommendation_id INT NOT NULL, user_id CHAR(36) NOT NULL, INDEX IDX_684B4397D173940B (recommendation_id), INDEX IDX_684B4397A76ED395 (user_id), UNIQUE INDEX unique_user_recommendation (recommendation_id, user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE app_group_recommendation ADD CONSTRAINT FK_30EF6577FE54D947 FOREIGN KEY (group_id) REFERENCES app_group (id)');
